---
title: Allin Futures API documentation
...
It can be accessed using the following domain names: futures.allintest.pro
...
## Restful Host:
    ...
    https://futures.allintest.pro

## Websocket Host:

    futures
    wss://futures.allintest.pro/wsf
...
```shell
curl "https://futures.allintest.pro/open/api/v2/market/kline"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/market/list"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/market/deals"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/market/depth"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/market/state"
...
```shell
cuel "https://futures.allintest.pro/open/api/v2/market/state/all"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/position/margin"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/deals"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/finished"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/market"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/cancel/all"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/detail"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/cancel"
```
...
```shell
"https://futures.allintest.pro/open/api/v2/order/limit"
```
...
```shell
"https://futures.allintest.pro/open/api/v2/order/pending"
...
```shell
"https://futures.allintest.pro/open/api/v2/order/stop"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/stop/cancel"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/stop/cancel/all"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/stop/pending"
...
```shell
curl "https://futures.allintest.pro/open/api/v2/order/stop/finished"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/setting/leverage"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/asset/query"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/asset/history"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/position/pending"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/position/close/limit"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/position/close/market"
```
...
```shell
curl "https://futures.allintest.pro/open/api/v2/position/close/stop"
```
